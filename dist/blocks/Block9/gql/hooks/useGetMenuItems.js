...
export var useGetMenuItems = function (menu_uuid) {
    ...
    return function (_a) { return __awaiter(void 0, void 0, void 0, function () {
        var _b, error, data, e_1;
        var onDataReceived = _a.onDataReceived, variables = __rest(_a, ["onDataReceived"]);
            ...
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, client.query({
                            ...
                            variables: __assign(__assign({}, variables), { menu_uuid: menu_uuid }),
                ...
                case 1:
                    ...
                    if (error || !data)
                        ...
                        onDataReceived === null || onDataReceived === void 0 ? void 0 : onDataReceived({
                            ...
                            paginatorInfo: data === null || data === void 0 ? void 0 : data.getMenuItems.paginatorInfo,
                        });
                    return [3 /*break*/, 3];
                case 2:
                    e_1 = _c.sent();
